...
const popularDestinations = [
  { id: 'tokyo', name: 'Tokyo', country: 'Japan', image: 'https://images.pexels.com/photos/2506923/pexels-photo-2506923.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2' },
  { id: 'paris', name: 'Paris', country: 'France', image: 'https://images.pexels.com/photos/699466/pexels-photo-699466.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2' },
  { id: 'newyork', name: 'New York', country: 'USA', image: 'https://images.pexels.com/photos/2129796/pexels-photo-2129796.png?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2' },
  { id: 'bali', name: 'Bali', country: 'Indonesia', image: 'https://images.pexels.com/photos/1694621/pexels-photo-1694621.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2' },
];
...
const CreateTrip: React.FC = () => {
  ...
  const getStepTitle = () => {
    switch (currentStep) {
      ...
      case 'dates': return 'When are you going?';
      case 'travelers': return 'Who is going?';
      case 'confirmation': return 'Ready to create your trip!';
      default: return '';
    }
  };
                ...
                {popularDestinations.map(dest => (
                  <div 
                    ...
                    className={`
                      ...
                      ${destination === dest.name ? 'ring-2 ring-purple-500' : ''}
                    `}
                  >
                    <img 
                      src={dest.image} 
                    ...
                    <div className="absolute inset-0 p-3 flex flex-col justify-end">
                      ...
                      <p className="text-white text-xs opacity-90">{dest.country}</p>
                    </div>
            ...
            {startDate && endDate && (
              <div className="bg-gray-50 p-3 rounded-xl">
                <p className="text-sm text-gray-600">
                  Your trip to <span className="font-semibold">{destination}</span> will be for{' '}
        ...
        {currentStep === 'confirmation' && (
          <div className="flex flex-col items-center justify-center py-10">
            ...
            <p className="text-center text-gray-600 mb-5">
              Your trip to {destination} is ready to be created.
              We'll help you plan everything from flights to activities.
            </p>
